import{j as t,c as y}from"./index-CAzESFca.js";import{e as h,r as j,L as i}from"./vendor-BNAX5WNf.js";import"./utils-BOsnGYVu.js";const u={id:"ch1",title:"第1章 有理数",summary:"有理数是初中数学的基础。本章从正数和负数的概念引入，学习有理数的分类、数轴、相反数、绝对值，以及有理数的四则运算、乘方和科学记数法。",sections:[{title:"1.1 正数和负数",content:`📌 核心定义
...
原式 = -4(-1)² - 3(-1) + 7
     = -4 + 3 + 7
     = 6`}],tips:["去括号时注意分配律","合并同类项时要找对同类项","代入负数时要注意加括号"]}],formulas:["同类项合并：ax + bx = (a+b)x","去括号：+(a-b) = a-b，-(a-b) = -a+b","添括号：+(a-b) = a-b，-(a-b) = -a+b","整式加减：先去括号，再合并同类项"],commonMistakes:["去括号时漏乘或符号错误","合并同类项时字母指数改变","不是同类项强行合并","代入负数时忘记加括号","系数是带分数时没有化成假分数","多项式项的符号看错"]},g={id:"ch3",title:"第3章 一元一次方程",summary:"本章学习一元一次方程的概念和等式的性质，掌握解一元一次方程的方法，能够列方程解决实际问题。",sections:[{title:"3.1 方程的基本概念",content:`📌 核心定义：
...
解得 x = 105（元）
答：标价是105元。`}],tips:["找等量关系是关键","单位要统一","解完后要检验是否符合实际","打8折 = 按原价的 80% 出售"]}],formulas:["等式性质1：若a=b，则a±c=b±c","等式性质2：若a=b，则ac=bc，a/c=b/c (c≠0)","路程=速度×时间","工作量=工作效率×时间","利润=售价-进价","利润率=利润/进价×100%"],commonMistakes:["移项时忘记变号","去分母时漏乘不含分母的项","去括号时漏乘或符号错误","解完后忘记检验","单位不统一就直接计算"]},f={id:"ch4",title:"第4章 几何图形初步",summary:"本章从生活中的实物抽象出几何图形，学习立体图形和平面图形，掌握直线、射线、线段和角的概念及性质。",sections:[{title:"4.1 几何图形",content:`📌 立体图形：各部分不都在同一平面内的图形
• 柱体：圆柱、棱柱
• 锥体：圆锥、棱锥
• 球体
...
因为OC是∠AOB的平分线
所以 ∠AOC = 1/2 ∠AOB = 1/2 × 60° = 30°`}],tips:["角平分线把角分成两个相等的角","角平分线是射线，不是直线","一个角只有一条平分线"]}],formulas:["1° = 60′，1′ = 60″","线段中点：AM = 1/2 AB","角平分线：∠AOC = 1/2 ∠AOB","互余：∠1 + ∠2 = 90°","互补：∠1 + ∠2 = 180°","同角（等角）的余角相等","同角（等角）的补角相等","两点之间线段最短","两点确定一条直线"],commonMistakes:["直线、射线、线段混淆","度分秒换算按100进制计算","认为互余的角必须相邻","角的表示方法不规范","角平分线画成直线","余角补角计算错误"]},A={id:"ch5",title:"第5章 相交线与平行线",summary:"本章学习相交线和平行线的概念和性质，掌握平行线的判定方法和性质，理解平移的概念。",sections:[{title:"5.1 相交线",content:`📌 对顶角：
...
(2) |−√2| + √2 = √2 + √2 = 2√2
(3) (√3)² − ³√(−27) = 3 − (−3) = 6`}],tips:["实数的运算律与有理数相同","0没有倒数","注意运算顺序"]}],formulas:["若x²=a（x>0,a≥0），则x=√a","若x³=a，则x=³√a","(√a)² = a (a≥0)","³√(a³) = a","√(a²) = |a|","³√(−a) = −³√a","正数的平方根有两个，互为相反数","任何实数都有唯一的立方根","0没有倒数"],commonMistakes:["认为所有带根号的数都是无理数","混淆平方根和算术平方根","负数求平方根","立方根根指数3省略不写","实数比较大小方法不当","忘记0没有倒数"]},v={id:"ch7",title:"第7章 平面直角坐标系",summary:"本章学习平面直角坐标系的概念，掌握点的坐标的确定方法，理解坐标方法的简单应用。",sections:[{title:"7.1 有序数对",content:`📌 定义：有**顺序**的两个数a与b组成的数对，叫做有序数对
记作：(a, b)
...
代入①：5+6y=19.4
y=2.4
答：铅笔1元/支，笔记本2.4元/本`}],tips:["找等量关系是关键","一般找两个不同的等量关系","解完后要检验是否符合实际"]}],formulas:["代入消元法：把一个未知数用另一个表示，代入另一个方程","加减消元法：使某未知数系数相同/相反，加减消去该未知数","加减口诀：同加异减","{x+y=a, x-y=b} ⇒ x=(a+b)/2, y=(a-b)/2"],commonMistakes:["代入时忘记加括号","加减消元时符号错误","去分母时漏乘","解完后忘记检验","单位不统一","消元时搞错应该加还是减"]},C={id:"ch9",title:"第9章 不等式与不等式组",summary:"本章学习不等式的概念和性质，掌握一元一次不等式和不等式组的解法，能够解决实际问题。",sections:[{title:"9.1 不等式",content:`📌 定义：
• 用符号"<"、">"、"≤"、"≥"、"≠"连接而成的式子叫做不等式
...
(3) 要表示家庭支出中各项所占比例 → 扇形统计图`}],tips:["条形图比多少，折线图看趋势，扇形图看比例","扇形圆心角=百分比×360°","不同统计图有不同的特点和用途"]}],formulas:["极差 = 最大值 - 最小值","组数 = 极差 ÷ 组距（进位取整）","频率 = 频数 ÷ 总数","各组频率之和 = 1","扇形圆心角 = 百分比 × 360°","条形统计图：比较数量","扇形统计图：显示百分比","折线统计图：显示趋势","直方图：显示分布"],commonMistakes:["样本容量带单位","组距和组数计算错误","频数和频率混淆","统计图选择不当","扇形圆心角计算错误","忘记验证频率之和是否等于1"]},o=[u,N,g,f,A,B,v,w,C,k],m=x=>o.find(l=>l.id===x),L=()=>{const{chapterId:x}=h(),[l,r]=j.useState(new Set([0])),s=x?m(x):null,b=e=>{const n=new Set(l);n.has(e)?n.delete(e):n.add(e),r(n)},d=()=>{s&&r(new Set(s.sections.map((e,n)=>n)))},p=()=>{r(new Set)};return x?s?t.jsxs("div",{className:"min-h-screen bg-gray-50 pb-24",children:[t.jsxs("header",{className:"bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white p-4 pb-8 sticky top-0 z-10",children:[t.jsxs("div",{className:"flex items-center justify-between mb-4",children:[t.jsx(i,{to:"/notes",className:"p-2 -ml-2 hover:bg-white/10 rounded-full transition-colors",children:t.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),t.jsxs("div",{className:"flex gap-2",children:[t.jsx("button",{onClick:d,className:"text-xs bg-white/20 px-3 py-1.5 rounded-full hover:bg-white/30 transition-colors",children:"展开全部"}),t.jsx("button",{onClick:p,className:"text-xs bg-white/20 px-3 py-1.5 rounded-full hover:bg-white/30 transition-colors",children:"收起全部"})]})]}),t.jsx("h1",{className:"font-bold text-2xl mb-2",children:s.title}),t.jsx("p",{className:"text-white/80 text-sm",children:s.summary})]}),t.jsxs("main",{className:"p-4 -mt-4",children:[t.jsx("div",{className:"space-y-4",children:s.sections.map((e,n)=>t.jsxs("div",{className:"bg-white rounded-2xl shadow-md overflow-hidden",children:[t.jsxs("button",{onClick:()=>b(n),className:"w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors",children:[t.jsx("h3",{className:"font-bold text-gray-800 text-left",children:e.title}),t.jsx("svg",{className:`w-5 h-5 text-gray-400 transition-transform ${l.has(n)?"rotate-180":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M19 9l-7 7-7-7"})})]}),l.has(n)&&t.jsxs("div",{className:"px-4 pb-4 border-t border-gray-100",children:[t.jsx("div",{className:"mt-4 text-gray-700 leading-relaxed whitespace-pre-line text-sm",children:e.content}),e.examples&&e.examples.length>0&&t.jsx("div",{className:"mt-4 space-y-3",children:e.examples.map((a,c)=>t.jsxs("div",{className:"bg-blue-50 rounded-xl p-4",children:[t.jsx("h4",{className:"font-bold text-blue-700 mb-2",children:a.title}),t.jsx("p",{className:"text-gray-700 text-sm whitespace-pre-line",children:a.content})]},c))}),e.tips&&e.tips.length>0&&t.jsxs("div",{className:"mt-4 bg-yellow-50 rounded-xl p-4",children:[t.jsxs("h4",{className:"font-bold text-yellow-700 mb-2 flex items-center",children:[t.jsx("span",{className:"mr-2",children:"💡"})," 学习提示"]}),t.jsx("ul",{className:"space-y-1",children:e.tips.map((a,c)=>t.jsxs("li",{className:"text-gray-700 text-sm flex items-start",children:[t.jsx("span",{className:"text-yellow-500 mr-2",children:"•"}),a]},c))})]})]})]},n))}),s.formulas&&s.formulas.length>0&&t.jsxs("div",{className:"mt-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-5 border-2 border-indigo-100",children:[t.jsxs("h3",{className:"font-bold text-gray-800 mb-4 flex items-center text-lg",children:[t.jsx("span",{className:"text-2xl mr-2",children:"📝"})," 公式汇总"]}),t.jsx("div",{className:"space-y-3",children:s.formulas.map((e,n)=>t.jsx("div",{className:"bg-white rounded-xl p-3 shadow-sm",children:t.jsx("p",{className:"text-gray-800 font-mono text-sm",children:e})},n))})]}),s.commonMistakes&&s.commonMistakes.length>0&&t.jsxs("div",{className:"mt-6 bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-5 border-2 border-red-100",children:[t.jsxs("h3",{className:"font-bold text-gray-800 mb-4 flex items-center text-lg",children:[t.jsx("span",{className:"text-2xl mr-2",children:"⚠️"})," 常见错误"]}),t.jsx("ul",{className:"space-y-2",children:s.commonMistakes.map((e,n)=>t.jsxs("li",{className:"text-gray-700 text-sm flex items-start",children:[t.jsxs("span",{className:"text-red-500 mr-2 font-bold",children:[n+1,"."]}),e]},n))})]})]})]}):t.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-50 p-4",children:t.jsxs("div",{className:"text-center bg-white rounded-3xl p-8 shadow-lg",children:[t.jsx("div",{className:"text-6xl mb-4",children:"📝"}),t.jsx("p",{className:"text-gray-500 text-lg mb-4",children:"该章节笔记正在整理中"}),t.jsx(i,{to:"/notes",className:"inline-block bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-6 py-3 rounded-xl font-bold",children:"返回笔记列表"})]})}):t.jsxs("div",{className:"min-h-screen bg-gray-50 pb-24",children:[t.jsxs("header",{className:"bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white p-6 pb-10 rounded-b-[2.5rem] shadow-xl",children:[t.jsxs("div",{className:"flex items-center mb-6",children:[t.jsx(i,{to:"/",className:"p-2 -ml-2 hover:bg-white/10 rounded-full transition-colors",children:t.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),t.jsx("h1",{className:"font-bold text-xl ml-2",children:"📚 知识点笔记"})]}),t.jsx("p",{className:"text-white/80 text-sm",children:"完整的初一数学知识点笔记，随时查阅复习"})]}),t.jsxs("main",{className:"p-4 -mt-6",children:[t.jsx("div",{className:"bg-white rounded-3xl p-5 shadow-lg mb-5",children:t.jsxs("div",{className:"flex items-center justify-between",children:[t.jsxs("div",{className:"text-center flex-1",children:[t.jsx("p",{className:"text-3xl font-bold text-indigo-600",children:o.length}),t.jsx("p",{className:"text-sm text-gray-500",children:"章节课"})]}),t.jsx("div",{className:"h-12 w-px bg-gray-200"}),t.jsxs("div",{className:"text-center flex-1",children:[t.jsx("p",{className:"text-3xl font-bold text-purple-600",children:o.reduce((e,n)=>e+n.sections.length,0)}),t.jsx("p",{className:"text-sm text-gray-500",children:"知识点"})]}),t.jsx("div",{className:"h-12 w-px bg-gray-200"}),t.jsxs("div",{className:"text-center flex-1",children:[t.jsx("p",{className:"text-3xl font-bold text-pink-600",children:o.reduce((e,n)=>{var a;return e+(((a=n.formulas)==null?void 0:a.length)||0)},0)}),t.jsx("p",{className:"text-sm text-gray-500",children:"公式"})]})]})}),t.jsx("div",{className:"space-y-4",children:y.map(e=>{const n=m(e.id),a=!!n;return t.jsx(i,{to:a?`/notes/${e.id}`:"#",className:`block bg-white rounded-3xl p-5 shadow-md transition-all ${a?"hover:shadow-xl active:scale-95":"opacity-50"}`,onClick:c=>!a&&c.preventDefault(),children:t.jsxs("div",{className:"flex items-center",children:[t.jsx("div",{className:"w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mr-4 shadow-inner",style:{backgroundColor:`${e.color}20`},children:e.icon}),t.jsxs("div",{className:"flex-1",children:[t.jsxs("div",{className:"flex items-center mb-1",children:[t.jsx("h3",{className:"font-bold text-gray-800 text-lg",children:e.title}),e.isKeyChapter&&t.jsx("span",{className:"ml-2 text-xs bg-red-100 text-red-600 px-2 py-1 rounded-full font-bold",children:"重点"})]}),t.jsx("p",{className:"text-gray-500 text-sm",children:e.subtitle}),a?t.jsxs("div",{className:"flex items-center mt-2 text-xs text-gray-400",children:[t.jsxs("span",{className:"mr-3",children:["📖 ",n.sections.length," 个知识点"]}),n.formulas&&t.jsxs("span",{children:["📝 ",n.formulas.length," 个公式"]})]}):t.jsx("p",{className:"text-xs text-gray-400 mt-2",children:"笔记整理中..."})]}),a&&t.jsx("svg",{className:"w-6 h-6 text-gray-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})},e.id)})})]})]})};export{L as default};
//# sourceMappingURL=index-BjjtiC_2.js.map
